...
const navigation = [
  { name: 'Facebook', href: 'https://www.facebook.com/yuma.jawa/' },
  { name: 'Instagram', href: 'https://www.instagram.com/yumaandhika/' },
  { name: 'Linkedin', href: 'https://www.linkedin.com/in/yuma-andhika-710458178/' },
  { name: '', href: '#' },
]
...
export default function Example() {
  return (
    <div className="relative overflow-hidden">
            ...
            <div className="flex items-center flex-1">
              <div className="flex items-center justify-between w-full">
                <a href="#">
                  ...
                  <span className="text-white">Ugly Holiday</span>
            ...
            <div className="rounded-3xl shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div className="px-5 pt-4 flex items-center justify-between">
                <div>
                  ...
                  <span className="">Ugly Holiday</span>
                </div>
                <div className="-mr-2">
      ...
      <main>
        <div className="pt-10 bg-gray-900 pt-36">
          <div className="mx-auto max-w-7xl">
              ...
              <div className="mx-auto max-w-md px-4 max-w-2xl px-6 text-center">
                <div className="">
                  <a href="#" className="inline-flex items-center text-white bg-black rounded-full p-1 pr-2 text-base hover:text-gray-200">
                    ...
                    <span className="ml-4 text-sm">Current Status</span>
                    <ChevronRightIcon className="ml-2 w-5 h-5 text-gray-500" aria-hidden="true" />
                  </a>
                  <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white mt-5 text-6xl">
                    <span className="block">Deadman no tales</span>
                    <span className="block mt-5 text-3xl text-indigo-400"><CountdownTimer/></span>
                  </h1>
                  <p className="mt-3 text-base text-gray-300 mt-5 text-xl">
                    Rising of the yourbae.
                  </p>
            ...
            <div className="mx-auto max-w-md px-4 max-w-2xl px-6" style={{ height: 520 }} />
